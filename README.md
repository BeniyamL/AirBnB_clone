...
## How the project works
   ...
   * finally after execution, the final output is displayed back to the user
...
## Usage
   ...
   * Run the project by writing ./console.py if you want execute in the interactive mode 
   * While the system prompts the user, write the required command
   * Or run the project by concatenating other commands with ./console.py if you want to execute in the non-interactive mode
